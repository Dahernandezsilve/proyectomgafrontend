...
const CardPersonal = ({
  ...
  const handleCheck = () => {
    setIsChecked(!isChecked); // Cambiar el estado de la marca de verificación al presionar el componente
  ...
  isTouchable ? (
    ...
    >
      ...
      >
        {isChecked && (
          <View style={styles.checkBoxChecked} /> // Mostrar la marca de verificación si está marcado
        )}
